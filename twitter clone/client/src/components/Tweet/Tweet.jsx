        ...
        <>
          ...
          <button onClick={handleLike}>
            {tweet.likes.includes(currentUser._id) ? (
              <FavoriteIcon className="mr-2 my-2 cursor-pointer bg-red-300"></FavoriteIcon>
            ) : (
              <FavoriteBorderIcon className="mr-2 my-2 cursor-pointer bg-red-300"></FavoriteBorderIcon>
            )}
            {tweet.likes.length}
          </button>
          { currentUser._id==id?(
            <button onClick={handleLike} className="ml-8">
            Delete
          </button>
          ):(
            <button onClick={handleLike} className="ml-8">
