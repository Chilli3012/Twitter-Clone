...
const Navbar = () => {
  ...
  return (
    <di1v className="grid grid-cols-1 md:grid-cols-4 my-5 justify-center bg-cyan-50 py-6 rounded-lg">
      ...
      <div className="px-0 md:px-6 mx-auto">
        ...
        <input type="text" className="bg-blue-100 rounded-full py-2 px-2" />
      </div>
    </di1v>
  );
};
